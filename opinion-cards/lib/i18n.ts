...
const STRINGS = {
  fr: {
    ...
    createShort: "Proposer",
    newCard: "Nouvelle carte",
    share: "Partager en story",
    sharePreparing: "Préparation…",
    shareRetry: "Réessayer",
    shareNeedsHttps: "Le partage natif exige HTTPS. En HTTP, l'image est téléchargée.",
    profile: "Mon profil",
    myCards: "Mes cartes",
    noCards: "Tu n'as encore proposé aucune carte.",
    statusPending: "En attente de validation",
    statusRejected: "Refusée par la modération",
    myVotes: "Tes votes",
    inMajority: "dans la majorité",
  ...
  en: {
    ...
    shareNeedsHttps: "Native sharing needs HTTPS. Over HTTP the image is downloaded.",
    profile: "My profile",
    myCards: "My cards",
    noCards: "You haven't posted any card yet.",
    statusPending: "Awaiting review",
    statusRejected: "Rejected by moderation",
    myVotes: "Your votes",
    inMajority: "in the majority",
  ...
  es: {
    ...
    createShort: "Publicar",
    newCard: "Nueva carta",
    share: "Compartir en story",
    sharePreparing: "Preparando…",
    shareRetry: "Reintentar",
    shareNeedsHttps: "Compartir requiere HTTPS. En HTTP se descarga la imagen.",
    profile: "Mi perfil",
    myCards: "Mis cartas",
    noCards: "Todavía no has publicado ninguna carta.",
    statusPending: "Pendiente de revisión",
    statusRejected: "Rechazada por moderación",
    myVotes: "Tus votos",
    inMajority: "en la mayoría",
